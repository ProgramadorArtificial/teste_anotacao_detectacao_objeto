...
# #### Configurations #### #
# Full path
path_labels = '[YOUR_FULL_PATH]/tmp/dataset/yolo'
path_images = '[YOUR_FULL_PATH]/tmp/dataset/images'
...
for idx, folder_train in enumerate(os.listdir(path_labels)):
    ...
    for folder_especific_train in os.listdir(f'{path_labels}/{folder_train}'):
        ...
        if is_continue:
            if folder_train == 'yolo-0_5-90-90-100' and folder_especific_train == 'bbox_larger':
                is_continue = False
            continue
